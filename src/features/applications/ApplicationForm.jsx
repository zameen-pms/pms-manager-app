				...
				<div className="column">
					...
					<ApplicationGrid>
						...
						<Input
							label="Monthly Rent"
							value={
								application?.currentResidence?.monthlyRent || ""
							}
							readOnly
							disabled
						/>
						...
						<Input
							...
							value={
								application?.currentResidence?.managerName || ""
							}
							readOnly
							disabled
						/>
				...
				<div className="column">
					...
					<ApplicationGrid>
						<Input
							label="Address"
							value={
								application?.previousResidence?.address || ""
							}
							readOnly
							disabled
						/>
				...
				<div className="column">
					...
					<ApplicationGrid>
						...
						<Input
							label="Occupation"
							value={
								application?.currentEmployer?.occupation || ""
							}
							readOnly
							disabled
						/>
				...
				<div className="column">
					...
					<ApplicationGrid>
						...
						<Input
							label="Occupation"
							value={
								application?.previousEmployer?.occupation || ""
							}
							readOnly
							disabled
						/>
				...
				<div className="column">
					<ApplicationGrid>
						...
						<Input
							label="Relationship"
							value={
								application?.otherReference?.relationship || ""
							}
							readOnly
							disabled
						/>
